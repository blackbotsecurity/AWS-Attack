...
is run automatically at awsattack.py execution, if no settings file is found. """
import os
...
# This removes the need to call the function in the middle of awsattack.py's imports

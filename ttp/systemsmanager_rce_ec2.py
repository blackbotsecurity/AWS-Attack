...
technique_info = {
    'blackbot_id': 'T1569.b.001',
    'external_id': '',
    'controller': 'systemsmanager_rce_ec2',
    'services': ['EC2', 'SSM'],
    'prerequisite_modules': ['ec2_enum_instances', 'iam_enum_roles'],
    ...
    'ttp_mitigation': '',
    'ttp_detection': '',
    'name': 'System Services: Systems Manager' ,
    'intent': 'Attempts to execute code as root/SYSTEM on EC2 instances.',
...
def main(args, awsattack_main):
    ...
    if ssm_instance_profile_name == '':
        ...
        if ssm_policy['AttachmentCount'] > 0:
            if fetch_data(['IAM', 'Roles'], technique_info['prerequisite_modules'][1], '--roles') is False:
                print('Pre-req module not run successfully. Exiting...\n')
                return

...
technique_info = {
    'blackbot_id': 'T1552.b.007',
    'external_id': '',
    'controller': 'enum_secrets_parameter_store',
    'services': ['SSM'],
...
def main(args, awsattack_main):
    ...
    import_path = 'ttp.src.enum_secrets_parameter_store_src'
...
def summary(data, awsattack_main):
    output = "    {} Parameter(s) were found in AWS Systems Manager Parameter Store".format(data["ParameterStore"])

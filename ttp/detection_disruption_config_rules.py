...
technique_info = {
    'blackbot_id': 'T1526',
    'external_id': '',
    'controller': 'detection_disruption_config_rules',
    'services': ['Config'],
    'prerequisite_modules': ['detection_enum_services_config'],
    'arguments_to_autocomplete': ['--action', '--config-rules'],
    'version': '1',
    'aws_namespaces': [],
...
parser.add_argument('--action', required=True, default=None, help='If you want to delete (del) the rules or skip (s)')

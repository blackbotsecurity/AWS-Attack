...
technique_info = {
    ...
    'controller': 'detection_enum_services_guardduty',
    ...
    'services': ['GuardDuty'],  # CloudWatch needs to be "monitoring" and VPC needs to be "EC2" here for "ls" to work
...
def main(args, awsattack_main, data=None):
    ...
    import_path = 'ttp.src.detection_enum_services_guardduty_src'

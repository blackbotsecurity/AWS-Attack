...
technique_info = {
    'blackbot_id': 'T1526',
    'external_id': '',
    'controller': 'ec2_backdoor_ec2_apply_rules_sec_groups',
    'services': ['EC2'],
    'prerequisite_modules': ['ec2_enum_securitygroups'],
    'arguments_to_autocomplete': ['--ip', '--port-range', '--protocol', '--groups', '--get-evidence-from'],
    'version': '1',
    'aws_namespaces': [],
...
parser.add_argument('--get-evidence-from', required=True, help='ec2_backdoor_enum_sec_groups')
...
def main(args, awsattack_main):
    ...
    if args.get_evidence_from != 'ec2_backdoor_enum_sec_groups':
    ...
    import_path = 'ttp.src.ec2_backdoor_apply_rules_sec_groups_src'

...
technique_info = {
    ...
    'arguments_to_autocomplete': ['--regions', '--get-evidence-from'],
    'version': '1',
    'aws_namespaces': [],
...
parser.add_argument('--get-evidence-from', required=True, help='codebuild_enum_projects')

def main(args, awsattack_main, data=None):
    args = parser.parse_args(args)

    if args.get_evidence_from != 'codebuild_enum_projects':
    ...
    import_path = 'ttp.src.codebuild_dumps_projects_src'
